    ...
    <div className=''>
        <div className='row fbCard p-2 m-3'>
            ...
            <div className='col-xl-7'>
                <h4>Serandib Tours is a comprehensive travel booking system designed to provide seamless and convenient travel arrangements for individuals, families, and groups. With a focus on personalized service and attention to detail, Serandib Tours aims to enhance the travel experience and create unforgettable memories for its customers.</h4>
